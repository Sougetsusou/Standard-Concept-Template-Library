...
if __name__ == "__main__":
    ...
    for data in data_list:
        ...
        for template, obj in objs.items():
            ...
            if (obj.semantic == 'Wheel'):
                res = region_knowledge_wrappers[template].check(wheel_affordance, pts)
            elif (obj.semantic == 'Button'):
                res = region_knowledge_wrappers[template].check(button_affordance, pts)
